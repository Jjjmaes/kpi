...
const helpContent = {
  ...
  kpi: {
    ...
    sections: [
      ...
      {
        title: '员工确认（专职KPI / 兼职费用）',
        content: `
          <h4>适用角色</h4>
          <ul>
            <li>所有员工：确认本人当月专职 KPI（分）与兼职费用（元）</li>
            <li>兼职成员：即便月度 KPI 尚未生成，也会从项目成员记录中展示兼职费用，便于确认</li>
          </ul>
          <h4>操作步骤</h4>
          <ol>
            <li>进入"KPI查询"页面，选择月份</li>
            <li>点击右侧按钮“我的KPI确认”</li>
            <li>在“专职KPI（分）”或“兼职费用（元）”列表中逐条查看</li>
            <li>如无异议，点击“确认无误”；如有问题，点击“有异议”并填写原因</li>
            <li>操作后状态将变更为“已确认”或“有异议”</li>
          </ol>
          <h4>注意事项</h4>
          <ul>
            <li>月份以当前页面选择的月份为准，未选择则默认上一个月</li>
            <li>兼职费用按元显示；专职 KPI 按分显示</li>
            <li>有异议需填写说明，便于管理员/财务跟进</li>
          </ul>
        `
      },
      {
        ...
        content: `
          <h4>校验规则</h4>
          <ul>
            <li>导出月度工资表前会校验是否存在待确认或有异议的 KPI/兼职费用</li>
            <li>若仍有未确认记录，导出会被阻止并提示待确认条目数量</li>
          </ul>
          <h4>处理建议</h4>
          <ul>
            <li>提醒相关员工在“我的KPI确认”完成确认或提交异议</li>
            <li>全部确认后再进行导出，确保结算数据准确</li>
          </ul>
        `
      },
      {
