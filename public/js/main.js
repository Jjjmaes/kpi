...
import { loadConfig, loadConfigHistory, loadPermissionsConfig, savePermissionsConfig, loadOrgInfo, viewConfigChange, loadSystemConfig } from './modules/system.js';
...
const ACTIONS = Object.freeze({
    ...
    onCreateMemberUserChange: () => onCreateMemberUserChange(),
    ...
    // KPI
    loadKPI: () => loadKPI(),
    loadMyKpiConfirmations: () => loadMyKpiConfirmations(),
    confirmKpiRecord: (id) => confirmKpiRecord(id),
    disputeKpiRecord: (id) => disputeKpiRecord(id),
    ...
    removeProjectAttachment: (index) => removeProjectAttachment(index),
    removeAddMemberAttachment: (index) => removeAddMemberAttachment(index),
    showDeliveryModal: (projectId, status) => showDeliveryModal(projectId, status),
    removeDeliveryAttachment: (index) => removeDeliveryAttachment(index),
    submitDelivery: (event, projectId, status) => submitDelivery(event, projectId, status),
    removeFinalDeliveryAttachment: (index) => removeFinalDeliveryAttachment(index),
    submitFinalDelivery: (event, projectId) => submitFinalDelivery(event, projectId),
    showPmDeliveryModal: (projectId) => showPmDeliveryModal(projectId),
    removePmDeliveryAttachment: (index) => removePmDeliveryAttachment(index),
    submitPmDelivery: (event, projectId) => submitPmDelivery(event, projectId),
    initiatePaymentRecord: (event, projectId) => initiatePaymentRecord(event, projectId),
    handleInitiatePaymentMethodChange: (projectId) => handleInitiatePaymentMethodChange(projectId),
    confirmPaymentRecord: (recordId, projectId, action) => confirmPaymentRecord(recordId, projectId, action),
    confirmPaymentFromDashboard: (recordId, projectId, action) => confirmPaymentFromDashboard(recordId, projectId, action),
    ...
    submitEditRole: (roleId) => submitEditRole(roleId),
